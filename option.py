...
parser.add_argument('--rgb-list', default='list/ucf-i3d-train.list', help='list of rgb features ')
...
parser.add_argument('--model_type', type=str, default='SAB', help='SEAttention, Model,SAB,RNN,TCN')
parser.add_argument('--snippet_num', type=int, default=32, help='25,32(default:32)')
